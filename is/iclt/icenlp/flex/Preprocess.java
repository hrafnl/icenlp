...
public class Preprocess {
   ...
   */
  public Preprocess(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  public Preprocess(java.io.InputStream in) {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Preprocess <inputfile>");
    }
    else {
      for (int i = 0; i < argv.length; i++) {
        Preprocess scanner = null;
        try {
          scanner = new Preprocess( new java.io.FileReader(argv[i]) );
