...
public class MapperLexicon 
{
	...
	/***
	 * Constructor for MapperLexicon.
	 * @param tagMapFile Location to a mapping file that the class
	 * reads from.
	 * @throws Exception
	 */
	public MapperLexicon(String tagMapFile, boolean showOutput) throws Exception 
	{	
		// Initialize the maps.
